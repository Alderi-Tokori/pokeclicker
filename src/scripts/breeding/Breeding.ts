...
class Breeding implements Feature {
    ...
    constructor(private multiplier: Multiplier) {
        ...
        BreedingController.defendingType1(+Settings.getSetting('breedingDefendingTypeFilter1').value);
        BreedingController.defendingType2(+Settings.getSetting('breedingDefendingTypeFilter2').value);
